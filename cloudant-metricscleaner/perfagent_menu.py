...
def process_defaults_config(cfile):
    default_connectioninfo = '/opt/cloudant-metricscleaner/perfagent_connection.info'
    ...
    default_thresholdsfile = '/opt/cloudant-metricscleaner/perfagent_thresholds.info'
    default_eventsexclusionsfile = '/opt/cloudant-metricscleaner/perfagent_eventsexclusions.info'
    default_statsexclusionsfile = '/opt/cloudant-metricscleaner/perfagent_statsexclusions.info'
    default_scope = 'endpoint'
    default_granularity = 'hour'
    default_performercount = 10
    default_resultslocation = '/opt/cloudant-metricscleaner/perfagent_results'
